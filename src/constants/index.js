...
export const name = "Naasson Hazzard";
export const role = "I am a Frontend Engineer in US.";
...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Real-time visualization dashboard using D3.js",
      "Improved reporting speed of the internal analytics",
      "Developed an accessible, responsive, and functional UI",
    ],
  },
];
